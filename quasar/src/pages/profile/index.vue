<template>
  <q-page class="profile-page full-width adjusted-height-profile items-center justify-center row" v-bind:class="{'profile-column': showBooking}">
    <div class="col-6 flex column items-center justify-start full-height">
  <!--    store bio -->
    <bio-component
    ...
    <q-dialog
      ...
      <q-card class="row q-pa-md">
        ...
        <mobile-account-review
          v-if="showBooking"
          v-bind:logo="response.logo"/>
        <div class="col-9 date-time flex column full-height q-px-md">
          <div class="row" >
